package homework.homework9.library;

import homework.homework9.library.Storage.AuthorStorage;
import homework.homework9.library.Storage.BookStorage;
...
public class LibraryDemo implements Commands {
        ...
        while (isRun) {
            ...
            switch (command) {
                ...
                case ADD_BOOK:
                    try {
                        addBook();
                    } catch (AuthorStorage.AuthorNotFoundException e) {
    ...
    private static void addBook() throws AuthorStorage.AuthorNotFoundException {
        System.out.println("Please choose author by phone number");
        authorStorage.print();
